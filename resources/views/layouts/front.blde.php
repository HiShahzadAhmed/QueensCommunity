...
<body>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<ul class="top-nav text-center">
					...
					<li class="hidden-xs"><a href="#">Watch |</a>
					</li>
					<li  class="hidden-xs"><a href="#">Hangout</a>
					</li>
				</ul>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-1 margin-top-20">
					<div class="btn-nav"><a href="#" class="btn btn-primary btn-sm navbar-btn">Post Question</a></div>
				</div>
			</div>
			<!--/.navbar-collapse -->
		</div>
					...
					<div class="col-md-12">
						<div class="footer-content text-center no-padding margin-bottom-40">
							<div class="logo-footer">
								<img id="logo-footer" class="center-block" src="assets/img/logo.png" alt="">
							</div>
	...
	<!-- Bootstrap Core Css  -->
	<script src="{{ asset('front/assets') }}/css/bootstrap/js/bootstrap.min.js"></script>
	<!-- Template Core JS -->
